<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeExpenseReportReview.aspx.cs" Inherits="DX_WebTemplate.AccedeExpenseReportReview" %>
                        ...
                        <dx:LayoutItem Caption="" ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="editBTN" runat="server" AutoPostBack="False" BackColor="#006DD6" ClientInstanceName="editBTN" Font-Bold="True" Font-Size="Small" Text="Edit" ForeColor="White">
                                        <ClientSideEvents Click="function(s, e) {
	window.open(&quot;AccedeExpenseReportSaves.aspx&quot;, &quot;_self&quot;);
}" />
                                    </dx:ASPxButton>
