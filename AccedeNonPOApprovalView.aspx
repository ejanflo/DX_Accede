...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function viewExpDetailModal(expDetailID) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    //supplier_edit.SetValue(response.d.supplier);
                    //tin_edit.SetValue(response.d.tin);
                    expLine_Invoice.SetValue(response.d.invoice);
        ...
        function approveForwardClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/btnApproveForwardAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function approveClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/btnApproveClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function ReturnClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/btnReturnClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function DisapproveClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/btnDisapproveClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function EditReimDetails() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/SaveReimDetailsAJAX",
                data: JSON.stringify({
                            ...
                            <dx:LayoutGroup Caption="CHARGED TO DETAILS" ColSpan="1">
                                ...
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="Charged To Company" ColSpan="1" Name="edit_CTComp" FieldName="InvChargedTo_CompanyId">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxComboBox ID="drpdown_CTComp" runat="server" ClientInstanceName="drpdown_CTComp" DataSourceID="SqlCompany" TextField="CompanyShortName" ValueField="CompanyId" Width="100%" Font-Bold="True" Font-Size="Small">
...
//drpdown_Comp.SetValue(s.GetValue());
                                    ...
                                    <dx:LayoutItem Caption="Charged To Department" ColSpan="1" Name="edit_CTDept" FieldName="InvChargedTo_DeptId">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxComboBox ID="drpdown_CTDepartment" runat="server" ClientInstanceName="drpdown_CTDepartment" DataSourceID="SqlCTDepartment" DropDownWidth="500px" NullValueItemDisplayText="{1}" OnCallback="drpdown_CTDepartment_Callback" TextField="DepDesc" TextFormatString="{1}" ValueField="ID" Width="100%" Font-Bold="True" Font-Size="Small">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	OnCTDeptChanged(s.GetValue());
                            ...
                            <dx:LayoutGroup Caption="VENDOR DETAILS" ColSpan="1">
                                ...
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="Invoice No." ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxTextBox ID="txt_InvoiceNo" runat="server" ClientInstanceName="txt_InvoiceNo" Font-Bold="True" Font-Size="Small" Width="100%" ReadOnly="True">
                                                    <Border BorderStyle="None" />
                                                    <BorderBottom BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
                                                </dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                    ...
                                    <dx:LayoutItem Caption="Currency" ColSpan="1" FieldName="Exp_Currency" Name="txt_Curr">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                    ...
                                    <dx:LayoutItem Caption="Payment Type" ColSpan="1" FieldName="PayTypeName" Name="txt_PayType">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
        ...
        linkToRFP();
                    ...
                    <dx:TabbedLayoutGroup ColSpan="2" ColumnSpan="2" Width="100%" ActiveTabIndex="1">
                        <Items>
                            <dx:LayoutGroup Caption="Cash Advances" ColSpan="1" ClientVisible="False">
                                <Items>
                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="ExpGrid" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlExpDetails" KeyFieldName="ExpenseReportDetail_ID" OnCustomButtonInitialize="ExpGrid_CustomButtonInitialize">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Line Description" FieldName="LineDescription" ShowInCustomizationForm="True" VisibleIndex="4">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:ASPxGridView>
                                            </dx:LayoutItemNestedControlContainer>
                            ...
                            <dx:LayoutGroup Caption="Reimbursements" ColSpan="1" ClientVisible="False">
                                <Items>
                                    <dx:LayoutItem Caption="" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
