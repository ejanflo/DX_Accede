...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function linkToRFP() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/RedirectToRFPDetailsAJAX",
                data: JSON.stringify({
                    rfpDoc: rfpDoc
        ...
        function viewExpDetailModal(expDetailID) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOApprovalView.aspx/DisplayExpDetailsAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        async function EditExpDetails() {
            if (ASPxClientEdit.ValidateGroup('PopupSubmit')) {
                ...
                $.ajax({
                    type: "POST",
                    url: "AccedeNonPOApprovalView.aspx/SaveExpDetailsAJAX",
                    data: JSON.stringify({
                        dateAdd: dateAdd,
                        //tin_no: tin_no,
