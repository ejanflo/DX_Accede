    ...
    <script>
        function OnCustomButtonClick(s, e) {
            ...
            if (e.buttonID == 'btnViewDisbursed') {
                ...
                s.GetRowValues(e.visibleIndex, 'DCT_Name', function (value) {
                    console.log(value);
                    console.log(rowKey + "|" + value + "|" + e.buttonID);
                    gridMainDisbursed.PerformCallback(rowKey + "|" + value + "|" + e.buttonID);
                });
...
<div class="centerPane conta" id="form1">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="90%" Theme="iOS">
        <Items>
            <dx:LayoutGroup Caption="My Disbursement History Page" ColSpan="1" GroupBoxDecoration="HeadingLine">
                <GroupBoxStyle>
                    ...
                    <dx:LayoutItem Caption="" ColSpan="1">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="gridMainDisbursed" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMainDisbursed" DataSourceID="SqlRFPDisbursed" EnableTheming="True" KeyFieldName="WFA_Id" OnCustomCallback="gridMainDisbursed_CustomCallback" OnHtmlDataCellPrepared="gridMainDisbursed_HtmlDataCellPrepared" Theme="iOS" Width="95%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="DateAssigned" ShowInCustomizationForm="True" VisibleIndex="2">
                                        ...
                                        <dx:GridViewDataTextColumn AdaptivePriority="1" FieldName="DateAction" ShowInCustomizationForm="True" VisibleIndex="4">
                                            <CellStyle HorizontalAlign="Left">
                                            </CellStyle>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn AdaptivePriority="2" Caption="Document Type" FieldName="DCT_Name" ShowInCustomizationForm="True" VisibleIndex="6">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataComboBoxColumn Caption="Creator" FieldName="User_ID" ShowInCustomizationForm="True" VisibleIndex="7">
                                            <PropertiesComboBox DataSourceID="SqlUsers" TextField="FullName" ValueField="EmpCode">
                                            </PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataComboBoxColumn AdaptivePriority="1" Caption="Company" FieldName="ChargedTo_CompanyId" ShowInCustomizationForm="True" VisibleIndex="3">
    ...
    <asp:SqlDataSource ID="SqlRFPDisbursed" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [vw_ACCEDE_I_CashierDisbursedAll] WHERE ([ActedBy_User_Id] = @ActedBy_User_Id) ORDER BY [DateAction] DESC">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlUsers" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ITP_S_UserMaster]"></asp:SqlDataSource>
</asp:Content>
