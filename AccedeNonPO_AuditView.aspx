<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeNonPO_AuditView.aspx.cs" Inherits="DX_WebTemplate.AccedeNonPO_AuditView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function linkToRFP() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/RedirectToRFPDetailsAJAX",
                data: JSON.stringify({
                    rfpDoc: rfpDoc
        ...
        function viewExpDetailModal(expDetailID) { //FOR VIEW
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/DisplayExpDetailsAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function viewExpDetailModal2(expDetailID) { //FOR EDIT
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/DisplayExpDetailsEditAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
                    expDetailID: expDetailID
        ...
        function approveClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/btnApproveClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function ReturnClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/btnReturnClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        function DisapproveClick() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPO_AuditView.aspx/btnDisapproveClickAjax",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
        ...
        async function EditExpDetails() {
            if (ASPxClientEdit.ValidateGroup('PopupSubmit')) {
                ...
                $.ajax({
                    type: "POST",
                    url: "AccedeNonPO_AuditView.aspx/SaveExpDetailsAJAX",
                    data: JSON.stringify({
                        dateAdd: dateAdd,
                        //tin_no: tin_no,
