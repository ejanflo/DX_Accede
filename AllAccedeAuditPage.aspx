<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AllAccedeAuditPage.aspx.cs" Inherits="DX_WebTemplate.AllAccedeAuditPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Font-Bold="False" Height="144px" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="ACCEDE Audit Page" ColSpan="1" GroupBoxDecoration="HeadingLine" Width="100%">
                                    ...
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxGridView ID="expenseGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="expenseGrid" Width="100%" DataSourceID="sqlAllApproval" KeyFieldName="WFA_Id" OnCustomCallback="expenseGrid_CustomCallback" OnCustomColumnDisplayText="expenseGrid_CustomColumnDisplayText">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataComboBoxColumn FieldName="STS_Description" ShowInCustomizationForm="True" VisibleIndex="9" Caption="Status">
...
FROM     vw_ACCEDE_I_AllAccedeAudit
