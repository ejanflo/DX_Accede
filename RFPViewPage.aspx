...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function RecallClick() {
            ...
            $.ajax({
                type: "POST",
                url: "RFPViewPage.aspx/RecallRFPMainAJAX",
                ...
                success: function (response) {
                    ...
                    if (response.d == "success") {
                        LoadingPanel.SetText('RFP Successfully recalled. Redirecting&hellip;');
                        LoadingPanel.Show();
	...
	LoadingPanel.Show();
                            ...
                            <dx:LayoutItem Caption="" ClientVisible="False" ColSpan="1" Name="recallBtn">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
...
CheckValidDocNo(edit_SAPDocNo.GetValue(), 2);
	...
	history.back()
                    ...
                    <dx:TabbedLayoutGroup ColSpan="1" Width="100%">
                        <Items>
                            <dx:LayoutGroup Caption="RFP Details" ColCount="2" ColSpan="1" ColumnCount="2" Width="100%">
                                <Items>
                                    <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2">
                                        ...
                                        <Items>
                                            <dx:LayoutItem Caption="Charged To Company" ColSpan="2" ColumnSpan="2" FieldName="CTCompName" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox18" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                            ...
                                            <dx:LayoutItem Caption="Location" ColSpan="2" ColumnSpan="2" FieldName="CompLocation" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox20" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Type of Transaction" ColSpan="2" ColumnSpan="2" FieldName="RFPTranType_Name" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox3" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Projected Liquidation Date" ClientVisible="False" ColSpan="2" ColumnSpan="2" Name="PLD" ShowCaption="True" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="PLD_lbl" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="2" ColumnCount="2" ColumnSpan="2" Width="100%">
                                                <Items>
...
onTravelClick();
                                            ...
                                            <dx:LayoutItem Caption="Travel Type" ColSpan="2" ColumnSpan="2" Name="TravType" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtbox_TravType" runat="server" ClientInstanceName="txtbox_TravType" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Classification" ColSpan="2" ColumnSpan="2" FieldName="ClassificationName" Name="ClassType" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox17" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Last day of transaction" ClientVisible="False" ColSpan="2" ColumnSpan="2" FieldName="LastDayTransact" Name="LDOT" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox11" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Nature of Disbursement/Purpose" ColSpan="2" ColumnSpan="2" FieldName="Purpose" Width="100%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxMemo ID="memo_Purpose" runat="server" ClientInstanceName="memo_Purpose" Font-Bold="True" ReadOnly="True" Width="100%">
...
" />
                                            ...
                                            <dx:LayoutItem Caption="Charge To Department" ColSpan="1" FieldName="CTDeptName">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox19" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Cost Center" ColSpan="1" FieldName="SAPCostCenter">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox6" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutGroup Caption="" ColSpan="1" Width="100%">
                                                ...
                                                <Items>
                                                    <dx:LayoutItem Caption="Amount" ColSpan="1">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="amount_lbl" runat="server" ClientInstanceName="amount_lbl" DisplayFormatString="#,##0.00" Font-Bold="True" Font-Size="Medium" HorizontalAlign="Right" ReadOnly="True" Width="100%">
                                                                    <Border BorderStyle="None" />
                                                                    <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutItem Caption="Link to existing Expense Report" ClientVisible="False" ColSpan="1" FieldName="ExpDocNo" Name="ExpDoc">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
...
" />
                    ...
                    <dx:TabbedLayoutGroup ColSpan="1" Width="100%">
                        <Items>
                            <dx:LayoutGroup Caption="Workflow" ColCount="3" ColSpan="2" ColumnCount="3" ColumnSpan="2" Width="100%">
                                <Items>
                                    <dx:LayoutGroup Caption="" ColCount="2" ColSpan="3" ColumnCount="2" ColumnSpan="3" GroupBoxDecoration="None" Width="100%">
                                        <Items>
                                            ...
                                            <dx:LayoutItem Caption="Workflow Deparment" ColSpan="1" FieldName="DepDesc" Width="50%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="ASPxTextBox5" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                            <Border BorderStyle="None" />
                                                            <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                        </dx:ASPxTextBox>
                                                    </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutGroup Caption="Workflow Details" ColSpan="1" GroupBoxDecoration="HeadingLine">
                                                ...
                                                <Items>
                                                    <dx:LayoutItem Caption="Workflow" ColSpan="1" FieldName="Name">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="ASPxTextBox14" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                                    <Border BorderStyle="None" />
                                                                    <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:LayoutGroup Caption="FAP Workflow Details" ColSpan="1" GroupBoxDecoration="HeadingLine">
                                                <Items>
                                                    <dx:LayoutItem Caption="Workflow" ColSpan="1" FieldName="FAPWorkflow">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxTextBox ID="ASPxTextBox15" runat="server" Font-Bold="True" ReadOnly="True" Width="100%">
                                                                    <Border BorderStyle="None" />
                                                                    <BorderBottom BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" />
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
    ...
    <dx:ASPxPopupControl ID="DisbursePopup" runat="server" HeaderText="Disburse Payment?" Modal="True" AllowDragging="True" ClientInstanceName="DisbursePopup" CloseAction="CloseButton" EnableViewState="False" PopupAnimationType="None" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" MaxWidth="50%" Width="1500px">
            ...
            <div class="scrollablecontainer2">
                ...
                <Items>
                    ...
                    <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Center" ClientVisible="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Are you sure you want to disburse payment to vendor?" Font-Size="Medium">
                                </dx:ASPxLabel>
                    ...
                    <dx:LayoutGroup Caption="" ColCount="3" ColSpan="1" ColumnCount="3" GroupBoxDecoration="HeadingLine" HorizontalAlign="Right" Width="100%">
                        <Items>
                            <dx:LayoutItem Caption="" ColSpan="1" Width="20%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Confirm Disburse" BackColor="#006838" AutoPostBack="False">
                                            <ClientSideEvents Click="function(s, e) {
        ...
        saveFinChanges(1);
                            ...
                            <dx:LayoutItem Caption="" ColSpan="1" Width="20%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="ASPxButton3" runat="server" Text="Cancel" AutoPostBack="False" BackColor="White" ForeColor="Gray">
                                            <ClientSideEvents Click="function(s, e) {
	        DisbursePopup.Hide();
        }" />
                                            <Border BorderColor="Gray" />
        ...
        <dx:ASPxPopupControl ID="RecallPopup" runat="server" HeaderText="Recall RFP?" Modal="True" AllowDragging="True" AutoUpdatePosition="True" ClientInstanceName="RecallPopup" CloseAction="CloseButton" CloseOnEscape="True" EnableViewState="False" PopupAnimationType="None" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
        <SettingsAdaptivity Mode="Always" VerticalAlign="WindowCenter" />
        <ContentCollection>
<dx:PopupControlContentControl runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout4" runat="server">
        <Items>
            ...
            <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Center">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxLabel ID="ASPxFormLayout1_E12" runat="server" Text="Are you sure you want to recall document?" Font-Size="Medium">
                        </dx:ASPxLabel>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
