<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeNonPOEditPage.aspx.cs" Inherits="DX_WebTemplate.AccedeNonPOEditPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function removeFromExp(item_id, btnCommand) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/RemoveFromExp_AJAX",
                data: JSON.stringify({
                    item_id: item_id,
        ...
        function AddExpDetails() {
            ...
            if (ASPxClientEdit.ValidateGroup('PopupSubmit')) {
                ...
                var gross_amount = total_add.GetValue() != 0.00 ? total_add.GetValue() : "0";
                var net_amount = net_amount_add.GetValue() != 0.00 ? net_amount_add.GetValue() : "0";
                //var supp = supplier.GetValue() != null ? supplier.GetValue() : "";
                var particu = particulars_add.GetValue() != null ? particulars_add.GetValue() : "0";
                var expCat = exp_category_add.GetValue() != null ? exp_category_add.GetValue() : "0";
                ...
                var itemDesc = expItem_desc_add.GetValue() != null ? expItem_desc_add.GetValue() : "";
                var qty = qty_add.GetValue() != null ? qty_add.GetValue() : "";
                var unit_price = unit_price_add.GetValue() != null ? unit_price_add.GetValue() : "";
                var assign = txt_assign.GetValue() != null ? txt_assign.GetValue() : "";
                var allowance = txt_allowance.GetValue() != null ? txt_allowance.GetValue() : "";
                var EWTTaxType = drpdown_EWTTaxType.GetValue() != null ? drpdown_EWTTaxType.GetValue() : "";
                var EWTTAmount = spin_EWTTAmount.GetValue() != null ? spin_EWTTAmount.GetValue() : "";
                var EWTTCode = txt_EWTTCode.GetValue() != null ? txt_EWTTCode.GetValue() : "";
                var asset = txt_Asset.GetValue() != null ? txt_Asset.GetValue() : "";
                var subasset = txt_SubAsset.GetValue() != null ? txt_SubAsset.GetValue() : "";
        ...
        function collectExpenseData(btn) {
            return {
                ...
                repName: getSafeValue(txt_vendorName),
                ...
                vendorCode: getSafeValue(drpdown_vendor),
                vendorTIN: getSafeValue(txt_TIN),
                vendorAddress: getSafeValue(memo_VendorAddress)
            };
        }

        function collectPayVendorData() {
            return {
                comp_id: getSafeValue(exp_Company),
                ...
                payee: getSafeValue(drpdown_vendor),
        ...
        async function AddReimbursement(stat) {
            ...
            try {
                const reimbursementData = collectPayVendorData();
                console.log("Sending reimbursement data...");

                const result = await postDataAsync("AccedeNonPOEditPage.aspx/AddRFPPayVendorAJAX", reimbursementData);
        ...
        async function SaveExpenseReport(btn) {
            try {
                ...
                const result = await postDataAsync("AccedeNonPOEditPage.aspx/UpdateExpenseAJAX", expenseData);

                if (result === "success") {
                    const redirectMap = {
                        SaveReimburse: "AccedeNonPOEditPage.aspx",
                        CreateSubmit: "AccedeInvoiceNonPODashboard.aspx",
                        Save: "AccedeInvoiceNonPODashboard.aspx",
                        Submit: "AccedeInvoiceNonPODashboard.aspx",
                        Save2: "AccedeNonPOEditPage.aspx"
                    };

                    const msg = {
                        Save: "Invoice Non-PO document successfully saved.",
                        Submit: "Invoice Non-PO document successfully submitted.",
                        CreateSubmit: "Invoice Non-PO document successfully submitted.",
                    }[btn] || "";
        ...
        function onAmountChanged(pay) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/CheckMinAmountAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
                    comp_id: comp_id,
        ...
        function setVendorFieldsColor(color) {
            ...
            function applyStyles(editor) {
                ...
                if (mainEl) {
                    ...
                    mainEl.style.borderBottom = "1px solid " + borderColor;
                }
            }
        ...
        function viewExpDetailModal(expDetailID) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/DisplayExpDetailsAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
                ...
                success: function (response) {
                    ...
                    ExpAllocGrid_edit.PerformCallback(expDetailID);
        ...
        function onEndCallback(s, e) {
            ...
            //var sum = 0;
            //s.GetBatchEditorValues('NetAmount', function (vals) {
            ...
            if (s.cpComputeUnalloc) {
                ...
                var total_unalloc = (total - alloc_amnt).toFixed(2);
        ...
        async function EditExpDetails() {
            if (ASPxClientEdit.ValidateGroup('PopupSubmit')) {
                ...
                var totalAlloc = GetTotalNetAmount(ExpAllocGrid_edit);
                var rowCount = ExpAllocGrid.GetVisibleRowsOnPage();
        ...
        function onCurrencyChanged() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/UpdateCurrencyAJAX",
                data: JSON.stringify({
                    currency: currency
        ...
        function linkToRFP() {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/RedirectToRFPDetailsAJAX",
                data: JSON.stringify({
                    rfpDoc: rfpDoc
        ...
        function ReimbursementTrap() {
            ...
            // Safely get visible row count from DevExpress ASPxGridView
            if (window.ExpenseGrid) {
                if (typeof ExpenseGrid.GetVisibleRowsOnPage === "function") {
                    totalRows = ExpenseGrid.GetVisibleRowsOnPage();
                } else if (typeof ExpenseGrid.GetDataRowCount === "function") {
                    // Fallback to total data row count if GetVisibleRowsOnPage is unavailable
                    totalRows = ExpenseGrid.GetDataRowCount();
                }
            }
            ...
            if (totalRows > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "AccedeNonPOEditPage.aspx/CheckReimburseValidationAJAX",
                    data: JSON.stringify({
                        t_amount: t_amount
                    }),
                    contentType: "application/json; charset=utf-8",
                ...
                alert("No invoice line items found. Please add at least one line item before submitting.");
            }
        ...
        function ReimbursementTrap2() {
            ...
            if (totalRows > 0) {
                LoadingPanel.SetText("Generating RFP (Payment to Vendor)&hellip;");
                LoadingPanel.Show();
                setTimeout(function () {
                    var t_amount = "1";
                    $.ajax({
                ...
                alert("No invoice line items found. Please add at least one line item before generating RFP.");
            }
        ...
        function DownloadCostAllocTemp() {
            $.ajax({
                type: "POST",
                url: "AccedeNonPOEditPage.aspx/GenerateTempCostAllocAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
...
if (ASPxClientEdit.ValidateGroup('ExpenseEdit')) { 
	SavePopup.Show();
                        ...
                        window.location.href = &quot;AccedeInvoiceNonPODashboard.aspx&quot;;
        }" />
                                            </dx:ASPxButton>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutGroup Caption="" ColSpan="2" GroupBoxDecoration="None" ColCount="2" ColumnCount="2" ColumnSpan="2" Width="100%">
                            <Items>
                                <dx:TabbedLayoutGroup ColSpan="1" Width="60%" VerticalAlign="Top">
                                    <Items>
                                        <dx:LayoutGroup Caption="CHARGED TO DETAILS" ColSpan="1" GroupBoxDecoration="None" Width="100%">
                                            <Items>
                                                ...
                                                <dx:LayoutItem Caption="Charged To Company" ColSpan="1" FieldName="InvChargedTo_CompanyId">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxComboBox ID="exp_CTCompany" runat="server" ClientInstanceName="exp_CTCompany" DataSourceID="SqlCompany" EnableTheming="True" Font-Bold="True" Font-Size="Small" TextField="CompanyDesc" ValueField="CompanyId" Width="100%">
...
//drpdwn_FAPWF.PerformCallback(s.GetValue());
                                                ...
                                                <dx:LayoutItem Caption="Charged To Department" ColSpan="1" FieldName="InvChargedTo_DeptId">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
	...
	OnCTDeptChanged(s.GetValue());
                                                ...
                                                <dx:LayoutItem Caption="Transaction Type" ColSpan="1" FieldName="InvoiceType_ID">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                ...
                                <dx:TabbedLayoutGroup ColSpan="1" HorizontalAlign="Right" VerticalAlign="Top" Width="40%">
                                    <Items>
                                        <dx:LayoutGroup Caption="VENDOR DETAILS" ColSpan="1" GroupBoxDecoration="None" Width="100%">
                                            <Items>
	...
	OnVendorChanged(s.GetValue());
                                                                ...
                                                                <Columns>
                                                                    <dx:ListBoxColumn FieldName="VendorCode" Name="Vendor Code">
                                                                    </dx:ListBoxColumn>
                                                                    <dx:ListBoxColumn FieldName="VendorName" Name="Vendor Name">
                                                                    </dx:ListBoxColumn>
                                                                </Columns>
                                                                <Items>
                                                ...
                                                <dx:LayoutItem Caption="Invoice No." ColSpan="1" FieldName="InvoiceNo" ClientVisible="False">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
...
//reim_Currency.SetValue(s.GetValue);
                                                ...
                                                <dx:LayoutItem Caption="Payment Type" ColSpan="1" Name="PayType" FieldName="PaymentType">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                ...
                                                <dx:LayoutItem Caption="" ColSpan="1" ClientVisible="False" HorizontalAlign="Right" Name="reimItem">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
...
alert('Please verify your workflow details.');
                                                ...
                                                <dx:LayoutGroup Caption="RFP DETAILS" ColSpan="1" Name="ReimLayout" ClientVisible="False">
                                                    <Items>
	            ...
	            linkToRFP();
                                        ...
                                        <dx:LayoutGroup Caption="INVOICE LINE ITEMS" ColSpan="2" ColumnSpan="2" GroupBoxDecoration="None" Width="100%">
                                            ...
                                            <Items>
                                                <dx:LayoutItem Caption="" ColSpan="1">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxGridView ID="ExpenseGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="ExpenseGrid" DataSourceID="SqlExpDetails" EnableCallBacks="False" Font-Size="Small" KeyFieldName="ID" Width="100%">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="ID" FieldName="ID" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="1">
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="Amount" FieldName="TotalAmount" ShowInCustomizationForm="True" VisibleIndex="8">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Quantity" FieldName="Qty" ShowInCustomizationForm="True" VisibleIndex="6">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Unit Price" FieldName="UnitPrice" ShowInCustomizationForm="True" VisibleIndex="7">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Net Amount" FieldName="NetAmount" ShowInCustomizationForm="True" VisibleIndex="12">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataComboBoxColumn Caption="Particulars" FieldName="Particulars" ShowInCustomizationForm="True" VisibleIndex="5">
                                                                        <PropertiesComboBox DataSourceID="SqlParticulars" TextField="P_Name" ValueField="ID">
                                                                        </PropertiesComboBox>
                                                                    </dx:GridViewDataComboBoxColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Line Description" FieldName="LineDescription" ShowInCustomizationForm="True" VisibleIndex="13">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Line No." FieldName="LineNum" ShowInCustomizationForm="True" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Invoice No." FieldName="InvoiceNo" ShowInCustomizationForm="True" VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="Net Of VAT" FieldName="NOVAT" ShowInCustomizationForm="True" VisibleIndex="9">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="VAT" FieldName="VAT" ShowInCustomizationForm="True" VisibleIndex="10">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="EWT" FieldName="EWT" ShowInCustomizationForm="True" VisibleIndex="11">
                                                                        <PropertiesTextEdit DisplayFormatString="#,##0.00">
                                                                        </PropertiesTextEdit>
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                ...
                                <dx:TabbedLayoutGroup ColSpan="2" ColumnSpan="2" Width="100%" ClientVisible="False">
                                    <Items>
...
var emp = &quot;&quot;;//exp_EmpId.GetValue() != null ? exp_EmpId.GetValue() : &quot;&quot;;
	...
	OnVendorChangedNoLoader(drpdown_vendor.GetValue());
       ...
       <%-- <asp:SqlDataSource ID="sqlCostCenter" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ACCEDE_S_CostCenter] WHERE (([CompanyId] = @CompanyId) AND ([DepartmentId] = @DepartmentId))">
          ...
          <dx:ASPxPopupControl ID="SubmitPopup" runat="server" HeaderText="Submit Invoice Non-PO document?" Modal="True" AllowDragging="True" AutoUpdatePosition="True" ClientInstanceName="SubmitPopup" CloseAction="CloseButton" CloseOnEscape="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" PopupAnimationType="None">
...
" />
	...
	SubmitPopup.Hide();
        ...
        <dx:ASPxPopupControl ID="SubmitPopup2" runat="server" HeaderText="Submit Invoice Non-PO document?" Modal="True" AllowDragging="True" AutoUpdatePosition="True" ClientInstanceName="SubmitPopup2" CloseAction="CloseButton" CloseOnEscape="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" PopupAnimationType="None" CssClass="rounded-bottom" Width="700px">
        <ContentCollection>
<dx:PopupControlContentControl runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout6" runat="server" ColCount="3" ColumnCount="3" Width="100%">
        ...
        <Items>
            ...
            <dx:LayoutItem Caption="" ColSpan="3" HorizontalAlign="Center" ColumnSpan="3" Width="100%">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxMemo ID="ASPxFormLayout6_E4" runat="server" Font-Size="Medium" HorizontalAlign="Center" Text="RFP (Payment to Vendor) will be automatically created once you submit this document. Are you sure you want to submit document?" Width="100%">
                            <Border BorderStyle="None" />
                        </dx:ASPxMemo>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            ...
            <dx:LayoutGroup ColCount="3" ColSpan="3" ColumnCount="3" ColumnSpan="3" GroupBoxDecoration="None" HorizontalAlign="Center" Width="100%">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Right" Width="30%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="btnCreateSubmitFinal" runat="server" AutoPostBack="False" BackColor="#0D6943" ClientInstanceName="btnCreateSubmitFinal" HorizontalAlign="Right" Text="Submit">
...
" />
	...
	SubmitPopup.Hide();
        ...
        <SettingsItems HorizontalAlign="Center" />
                    ...
                    <dx:ASPxPopupControl ID="SavePopup" runat="server" HeaderText="Save Invoice Non-PO document?" Modal="True" AllowDragging="True" AutoUpdatePosition="True" ClientInstanceName="SavePopup" CloseAction="CloseButton" CloseOnEscape="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" PopupAnimationType="None">
        <SettingsAdaptivity Mode="Always" VerticalAlign="WindowCenter" />
        <ContentCollection>
<dx:PopupControlContentControl runat="server">
...
<dx:PopupControlContentControl runat="server">
	...
	PetCashPopup.Hide();
        ...
        <dx:ASPxPopupControl ID="expensePopup1" runat="server" FooterText="" HeaderText="Add Line Item" Width="1500px" ClientInstanceName="expensePopup1" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AllowDragging="True" CloseAction="CloseButton" CssClass="rounded" PopupAnimationType="None" Font-Size="Small" MaxWidth="80%">
...
AddExpDetails();
                                ...
                                <dx:LayoutGroup Caption="" ColSpan="1" GroupBoxDecoration="None" Width="50%" HorizontalAlign="Left">
                                    <Items>
                                        <dx:LayoutItem Caption="Date" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxDateEdit ID="date_added_add" runat="server" ClientInstanceName="date_added_add" DisplayFormatString="MMMM dd, yyyy" Font-Bold="False" Font-Size="Small" Width="100%">
                                        ...
                                        <dx:LayoutItem Caption="Expense Type" ColSpan="1" Width="60%">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxComboBox ID="particulars_add" runat="server" ClientInstanceName="particulars_add" DataSourceID="SqlParticulars" Font-Bold="False" Font-Size="Small" NullValueItemDisplayText="{1}" TextField="P_Name" TextFormatString="{0} - {1}" ValueField="ID" Width="100%">
                                                        <Columns>
                                        ...
                                        <dx:LayoutItem Caption="Invoice/OR No." ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="invoice_add" runat="server" ClientInstanceName="invoice_add" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" IsRequired="True" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Expense Category" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxComboBox ID="exp_category_add" runat="server" ClientInstanceName="exp_category_add" DataSourceID="SqlExpCat" Font-Bold="False" Font-Size="Small" NullValueItemDisplayText="{1}" TextField="Description" TextFormatString="{0} - {1}" ValueField="ID" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" IsRequired="True" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Assignment" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_assign" runat="server" ClientInstanceName="txt_assign" Font-Bold="False" Font-Size="Small" Width="100%">
                                        ...
                                        <dx:LayoutItem Caption="Allowance" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_allowance" runat="server" ClientInstanceName="txt_allowance" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="EWT Tax Amount" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="spin_EWTTAmount" runat="server" ClientInstanceName="spin_EWTTAmount" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="999999999" Number="0.00" Width="100%">
	...
	computeNetAmount(&quot;add&quot;);
                                        ...
                                        <dx:LayoutItem Caption="EWT Tax Code" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_EWTTCode" runat="server" ClientInstanceName="txt_EWTTCode" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Line Description" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxMemo ID="expItem_desc_add" runat="server" ClientInstanceName="expItem_desc_add" Font-Bold="True" Font-Size="Small" HorizontalAlign="Left" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" IsRequired="True" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                ...
                                <dx:LayoutGroup ColSpan="1" GroupBoxDecoration="None" Width="50%" HorizontalAlign="Left" ColCount="2" ColumnCount="2">
                                    <Items>
                                        <dx:LayoutItem Caption="Quantity" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="qty_add" runat="server" ClientInstanceName="qty_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	computeNetAmount(&quot;add&quot;);
                                        ...
                                        <dx:LayoutItem Caption="UOM" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxComboBox ID="exp_UOM_add" runat="server" ClientInstanceName="exp_UOM_add" DataSourceID="SqlUOM" Font-Bold="False" Font-Size="Small" NullValueItemDisplayText="{1}" TextField="UOFMCode" TextFormatString="{0} - {1}" ValueField="UOFMCode" Width="100%">
                                                        <Columns>
                                        ...
                                        <dx:LayoutItem Caption="Unit Price" ColSpan="2" HorizontalAlign="Left" ColumnSpan="2">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="unit_price_add" runat="server" ClientInstanceName="unit_price_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	computeNetAmount(&quot;add&quot;);
                                        ...
                                        <dx:LayoutItem Caption="Gross Amount" ColSpan="2" ColumnSpan="2">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="total_add" runat="server" AllowNull="False" ClientInstanceName="total_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" Increment="100" MaxValue="99999999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	...
	computeNetAmount(&quot;add&quot;);
                                                    ...
                                                    <dx:ASPxSpinEdit ID="vat_add" runat="server" AllowNull="False" ClientInstanceName="vat_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" Increment="100" MaxValue="99999999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
    //netAmount.SetValue(s.GetValue());
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <asp:Panel ID="Panel1" runat="server" CssClass="exp-link-container">
                                                        <dx:ASPxSpinEdit ID="net_vat_add" runat="server" AllowNull="False" ClientInstanceName="net_vat_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" Increment="100" MaxValue="99999999999999" Number="0.00" Width="100%">
                                                            <SpinButtons ClientVisible="False">
                                                            </SpinButtons>
                                                            <ClientSideEvents ValueChanged="function(s, e) {
	    //netAmount.SetValue(s.GetValue());
	...
	computeNetAmount(&quot;add&quot;);
                                        ...
                                        <dx:LayoutItem Caption="EWT" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="ewt_add" runat="server" AllowNull="False" ClientInstanceName="ewt_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" Increment="100" MaxValue="99999999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	//netAmount.SetValue(s.GetValue());
	
	computeNetAmount(&quot;add2&quot;);
}" />
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                        ...
                                        <dx:LayoutItem Caption="Net Amount" ColSpan="2" ColumnSpan="2">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="net_amount_add" runat="server" ClientInstanceName="net_amount_add" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="99999999999999" Number="0.00" ReadOnly="True" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <Border BorderStyle="None" />
                                                        <BorderBottom BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" />
                                        ...
                                        <dx:LayoutItem Caption="Asset" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_Asset" runat="server" ClientInstanceName="txt_Asset" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Sub Asset Code" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_SubAsset" runat="server" ClientInstanceName="txt_SubAsset" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Alt Recon" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_AltRecon" runat="server" ClientInstanceName="txt_AltRecon" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="SL Code" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_SLCode" runat="server" ClientInstanceName="txt_SLCode" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Special GL" ColSpan="1" ClientVisible="False">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="txt_SpecialGL" runat="server" ClientInstanceName="txt_SpecialGL" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutGroup Caption="" ColSpan="2" ColumnSpan="2" Width="100%" ClientVisible="False" Name="EditAllocGrid">
                                            <Items>
                                                <dx:LayoutItem ColSpan="1" Width="100%" ShowCaption="False">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server">
                                                            <dx:ASPxGridView ID="ExpAllocGrid_edit" runat="server" AutoGenerateColumns="False" ClientInstanceName="ExpAllocGrid_edit" KeyFieldName="InvoiceDetailMap_ID" OnCustomCallback="ExpAllocGrid_edit_CustomCallback" OnRowDeleting="ExpAllocGrid_edit_RowDeleting" OnRowInserting="ExpAllocGrid_edit_RowInserting" Width="100%" OnRowUpdating="ExpAllocGrid_edit_RowUpdating" DataSourceID="SqlInvMap" OnBatchUpdate="ExpAllocGrid_edit_BatchUpdate">
                                                                <ClientSideEvents EndCallback="onEndCallback" />
                                                                <SettingsPager Mode="EndlessPaging">
                                                                </SettingsPager>
                                                                <SettingsEditing Mode="Batch">
...
" />
        ...
        <%--<dx:ASPxPopupControl ID="expensePopup_edit1" runat="server" FooterText="" HeaderText="Edit Expense Item" Width="1200px" ClientInstanceName="expensePopup_edit1" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AllowDragging="True" CloseAction="CloseButton" CssClass="rounded" PopupAnimationType="None" Font-Size="Small">
                        <CloseButtonImage IconID="outlookinspired_close_svg_white_16x16">
                        </CloseButtonImage>
	...
	EditExpDetails();
                     ...
                     expensePopup_edit.Hide();
                        ...
                        <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2" GroupBoxDecoration="None" HorizontalAlign="Center" Width="100%">
                            <Items>
                                <dx:LayoutGroup Caption="" ColSpan="1" GroupBoxDecoration="None" Width="50%" HorizontalAlign="Center" Name="ErrorLabel">
                                    <Items>
                                        ...
                                        <dx:LayoutItem Caption="Invoice/OR No." ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxTextBox ID="invoiceOR_edit" runat="server" ClientInstanceName="invoiceOR_edit" Font-Bold="False" Font-Size="Small" Width="100%">
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" />
                                                        </ValidationSettings>
                                                        <Border BorderStyle="None" />
                                        ...
                                        <dx:LayoutItem Caption="Account to be Charged" ColSpan="1" ClientVisible="False" Width="50%">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                ...
                                <dx:LayoutGroup ColSpan="1" GroupBoxDecoration="None" Width="50%">
                                    <Items>
                                        <dx:LayoutItem Caption="Cost Center" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxComboBox ID="costCenter_edit" runat="server" ClientInstanceName="costCenter_edit" DataSourceID="sqlCostCenter" DropDownWidth="200px" Font-Bold="False" Font-Size="Small" NullValueItemDisplayText="{0} - {1}" OnCallback="costCenter_edit_Callback" TextField="SAP_CostCenter" TextFormatString="{0}" ValueField="SAP_CostCenter" Width="100%">
                                                        <ClearButton DisplayMode="Always">
                                                        </ClearButton>
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="PopupSubmit">
                                                            <RequiredField ErrorText="*Required" IsRequired="True" />
                                        ...
                                        <dx:LayoutItem Caption="Gross Amount" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="grossAmount_edit" runat="server" AllowNull="False" ClientInstanceName="grossAmount_edit" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" Increment="100" MaxValue="99999999999999" Number="0.00" Width="100%">
                                                        <ClientSideEvents ValueChanged="function(s, e) {
...
computeNetAmount(&quot;edit&quot;);
                                        ...
                                        <dx:LayoutItem Caption="VAT" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="vat_edit" runat="server" ClientInstanceName="vat_edit" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	computeNetAmount(&quot;edit&quot;);
                                        ...
                                        <dx:LayoutItem Caption="EWT" ColSpan="1" HorizontalAlign="Left" Width="55%">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="ewt_edit" runat="server" ClientInstanceName="ewt_edit" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="999999999" Number="0.00" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <ClientSideEvents ValueChanged="function(s, e) {
	computeNetAmount(&quot;edit&quot;);
                                        ...
                                        <dx:LayoutItem Caption="Net Amount" ColSpan="1">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server">
                                                    <dx:ASPxSpinEdit ID="netAmount_edit" runat="server" ClientInstanceName="netAmount_edit" DecimalPlaces="2" DisplayFormatString="N" Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" MaxValue="99999999999999" Number="0.00" ReadOnly="True" Width="100%">
                                                        <SpinButtons ClientVisible="False">
                                                        </SpinButtons>
                                                        <Border BorderStyle="None" />
                                                        <BorderBottom BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" />
                                ...
                                <dx:LayoutGroup Caption="" ColSpan="2" ColumnSpan="2" GroupBoxDecoration="Box" Width="100%">
                                    <Items>
...
" />
    ...
    <asp:SqlDataSource ID="SqlMain" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ACCEDE_T_InvoiceMain] WHERE ([ID] = @ID)">
        <SelectParameters>
