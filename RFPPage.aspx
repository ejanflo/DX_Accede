<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="RFPPage.aspx.cs" Inherits="DX_WebTemplate.RFPPage" %>
...
<div class="centerPane conta" id="form1">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%" Theme="iOS">
        <Items>
            <dx:LayoutGroup Caption="Request For Payment" ColSpan="1" GroupBoxDecoration="HeadingLine">
                <GroupBoxStyle>
                    ...
                    <dx:LayoutItem Caption="" ColSpan="1" Width="100%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="gridMain" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMain" DataSourceID="SqlRFP" EnableTheming="True" KeyFieldName="ID" OnCustomCallback="gridMain_CustomCallback" Theme="iOS" Width="100%" OnHtmlDataCellPrepared="gridMain_HtmlDataCellPrepared" OnCustomButtonInitialize="gridMain_CustomButtonInitialize">
                                    ...
                                    <Columns>
                                        <dx:GridViewCommandColumn ShowInCustomizationForm="True" VisibleIndex="0" Caption="Action">
                                            <CustomButtons>
                                                ...
                                                <dx:GridViewCommandColumnCustomButton ID="btnPrint" Text="Print">
                                                    ...
                                                    <Styles>
                                                        <Style Font-Bold="True" BackColor="#E67C03" Font-Size="Smaller" ForeColor="White">
                                                            <Paddings PaddingBottom="4px" PaddingLeft="8px" PaddingRight="8px" PaddingTop="4px" />
                                                        </Style>
                                                    </Styles>
                                                </dx:GridViewCommandColumnCustomButton>
                                            ...
                                            <Columns>
                                                <dx:GridViewDataTextColumn Caption="Doc No." FieldName="RFP_DocNum" ShowInCustomizationForm="True" VisibleIndex="0">
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Purpose" ShowInCustomizationForm="True" VisibleIndex="7" Caption="Purpose">
                                            <Columns>
                                                ...
                                                <dx:GridViewDataComboBoxColumn AdaptivePriority="3" FieldName="PayMethod" ShowInCustomizationForm="True" VisibleIndex="1">
                                                    <PropertiesComboBox DataSourceID="SqlPayMethod" TextField="PMethod_name" ValueField="ID">
                                                    </PropertiesComboBox>
                                                </dx:GridViewDataComboBoxColumn>
                                            </Columns>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataComboBoxColumn FieldName="TranType" ShowInCustomizationForm="True" VisibleIndex="8" AdaptivePriority="2" Caption="Transaction Type">
                                            <PropertiesComboBox DataSourceID="SqlTranType" TextField="RFPTranType_Name" ValueField="ID">
                                            </PropertiesComboBox>
                                            <Columns>
                                                <dx:GridViewDataTextColumn AdaptivePriority="1" FieldName="Amount" ShowInCustomizationForm="True" VisibleIndex="0">
    ...
    <dx:ASPxPopupControl ID="RFPPopup" runat="server" HeaderText="RFP DETAILS" ClientInstanceName="RFPPopup" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" MinWidth="1000px"><ContentCollection>
<dx:PopupControlContentControl runat="server">
    <div id="scrollableContainer" >
        ...
        <Items>
            <dx:LayoutGroup ColSpan="1" Name="RFPMainViewForm" ColCount="2" ColumnCount="2" GroupBoxDecoration="HeadingLine">
                <GroupBoxStyle>
                    <Caption Font-Size="Medium">
                    </Caption>
                </GroupBoxStyle>
                <Items>
                    <dx:LayoutGroup Caption="" ClientVisible="False" ColSpan="2" GroupBoxDecoration="None" HorizontalAlign="Right" Name="btnLayoutGroup" ColCount="3" ColumnCount="3" ColumnSpan="2" Width="100%">
                        <Items>
                            <dx:LayoutItem Caption="" ColSpan="1" Name="editBTN" HorizontalAlign="Right">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="btnEditSubmit" runat="server" ClientInstanceName="btnEditSubmit" Text="Submit" AutoPostBack="False" HorizontalAlign="Right">
...
" />
                            ...
                            <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Right">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="btnEditSave" runat="server" Text="Save" ClientInstanceName="btnEditSave" AutoPostBack="False" BackColor="#006DD6" HorizontalAlign="Right">
                                            <ClientSideEvents Click="function(s, e) {
	SavePopup.Show();
}" />
                    ...
                    <dx:LayoutGroup Caption="" ColSpan="1" GroupBoxDecoration="None">
                        <Items>
                            <dx:LayoutItem Caption="Company" ColSpan="1" Name="Company_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="Company_modal" runat="server" ClientInstanceName="Company_modal" DataSourceID="SqlCompanyEdit" TextField="CompanyShortName" ValueField="CompanyId" Width="100%">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
	Department_modal.PerformCallback(s.GetValue());
drpdown_WF_modal.PerformCallback();
ifComp_is_DLI();
}" />
                            ...
                            <dx:LayoutItem Caption="Payment Method" ColSpan="1" Name="PayMethod_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="PayMethod_modal" runat="server" ClientInstanceName="PayMethod_modal" DataSourceID="SqlPayMethod" TextField="PMethod_name" ValueField="ID" Width="100%">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
	onPayMethodChanged();
}" />
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                            ...
                            <dx:LayoutItem Caption="Transaction Type" ColSpan="1" Name="TranType_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="TranType_modal" runat="server" ClientInstanceName="TranType_modal" DataSourceID="SqlTranType" TextField="RFPTranType_Name" ValueField="ID" Width="100%">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
ifTranType_is_CA();
                            ...
                            <dx:LayoutItem Caption="Projected Liquidation Date" ClientVisible="False" ColSpan="1" Name="pld">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxDateEdit ID="pld_modal" runat="server" ClientInstanceName="pld_modal" Width="100%">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                                <RequiredField ErrorText="This field is required." IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxDateEdit>
                                        <dx:ASPxTextBox ID="pld_lbl_modal" runat="server" ClientInstanceName="pld_lbl_modal" HorizontalAlign="Left" ReadOnly="True" Width="170px">
                                            <BorderLeft BorderStyle="None" />
                                            <BorderTop BorderStyle="None" />
                                            <BorderRight BorderStyle="None" />
                                            <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
	...
	OnTravChanged();
                            ...
                            <dx:LayoutItem Caption="Last Day of Transaction" ColSpan="1" Name="LastDay_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxDateEdit ID="LastDay_modal" runat="server" ClientInstanceName="LastDay_modal" Width="100%">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                                <RequiredField ErrorText="This field is required." IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxDateEdit>
                            ...
                            <dx:LayoutItem Caption="WBS" ColSpan="1" Name="WBS">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="WBS_modal" runat="server" ClientInstanceName="WBS_modal" Width="100%">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                                        <dx:ASPxTextBox ID="WBS_lbl_modal" runat="server" ClientInstanceName="WBS_lbl_modal" HorizontalAlign="Left" ReadOnly="True" Width="170px">
                                            <BorderLeft BorderStyle="None" />
                                            <BorderTop BorderStyle="None" />
                                            <BorderRight BorderStyle="None" />
                                            <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
                    ...
                    <dx:LayoutGroup Caption="" ColSpan="1" GroupBoxDecoration="None">
                        <Items>
                            <dx:LayoutItem Caption="Department" ColSpan="1" Name="Department_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <dx:ASPxTextBox runat="server" Width="100%" ClientInstanceName="CostCenter_modal" ID="CostCenter_modal">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                                <RequiredField ErrorText="This field is required." IsRequired="True" />
                                            </ValidationSettings>
</dx:ASPxTextBox>
                            ...
                            <dx:LayoutItem Caption="Cost Center" ColSpan="1" Name="CostCenter_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="Department_modal" runat="server" ClientInstanceName="Department_modal" DataSourceID="SqlDepartmentEdit" OnCallback="Department_modal_Callback" TextField="DepDesc" ValueField="ID" Width="100%">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
	onDeptChanged();
}" />
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                        ...
                                        <dx:ASPxTextBox ID="Department_lbl_modal" runat="server" ClientInstanceName="Department_lbl_modal" Width="170px" HorizontalAlign="Left" ReadOnly="True">
                                            <BorderLeft BorderStyle="None" />
                                            <BorderTop BorderStyle="None" />
                                            <BorderRight BorderStyle="None" />
                                            <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:LayoutItem Caption="IO" ColSpan="1" Name="IO_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="Payee_modal" runat="server" ClientInstanceName="Payee_modal" Width="100%">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                                <RequiredField ErrorText="This field is required." IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                            ...
                            <dx:LayoutItem Caption="Payee" ColSpan="1" Name="Payee_modal">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="IO_modal" runat="server" ClientInstanceName="IO_modal" Width="100%">
                                            <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom">
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                            ...
                            <dx:LayoutItem Caption="Account To Be Charged" ColSpan="1">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="ExpID_modal" runat="server" ClientInstanceName="ExpID_modal" DataSourceID="SqlExpense" TextField="DocNo" ValueField="ID" Width="100%">
                                            <Columns>
                                                <dx:ListBoxColumn Caption="Document No." FieldName="DocNo" Width="30%">
                                                </dx:ListBoxColumn>
                                        ...
                                        <dx:ASPxTextBox ID="ExpID_lbl_modal" runat="server" ClientInstanceName="ExpID_lbl_modal" HorizontalAlign="Left" ReadOnly="True" Width="170px">
                                            <BorderLeft BorderStyle="None" />
                                            <BorderTop BorderStyle="None" />
                                            <BorderRight BorderStyle="None" />
                                            <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:LayoutItem Caption="Link to existing Expense Report" ColSpan="1">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="expCat_modal" runat="server" ClientInstanceName="expCat_modal" DataSourceID="SqlExpCat" TextField="Description" ValueField="ID" Width="100%">
                                        </dx:ASPxComboBox>
                                        <dx:ASPxTextBox ID="expCat_lbl_modal" runat="server" ClientInstanceName="expCat_lbl_modal" HorizontalAlign="Left" ReadOnly="True" Width="170px">
                                            <BorderLeft BorderStyle="None" />
                                            <BorderTop BorderStyle="None" />
                                            <BorderRight BorderStyle="None" />
                                            <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
                    ...
                    <dx:LayoutGroup Caption="Note: Payment to vendors or non-employee transactions should be reflected at gross amount" ColSpan="2" ColumnSpan="2" Width="100%">
                        <GroupBoxStyle>
                    ...
                    <dx:LayoutGroup Caption="" ColSpan="1" ColCount="2" ColumnCount="2">
                                ...
                                <Items>
                                    <dx:LayoutItem Caption="Workflow" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxComboBox ID="drpdown_WF_modal" runat="server" TextField="WorkflowHeader_Name" ValueField="WF_Id" ClientInstanceName="drpdown_WF_modal" DataSourceID="SqlWF" Width="250px" OnCallback="drpdown_WF_modal_Callback">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	OnWFChanged();
}" />
                                                    <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                            ...
                            <dx:LayoutGroup Caption="FAP Workflow Details" ColSpan="1" GroupBoxDecoration="HeadingLine">
                                <Items>
                                    <dx:LayoutItem Caption="Workflow" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxComboBox ID="FAPWF_modal" runat="server" ClientInstanceName="FAPWF_modal" OnCallback="FAPWF_modal_Callback" DataSourceID="SqlFAPWF2" TextField="Name" ValueField="WF_Id" Width="250px">
                                                    <ValidationSettings Display="Dynamic" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidationGroup="RFPEditForm">
                                                        <RequiredField ErrorText="This field is required." IsRequired="True" />
                                                    </ValidationSettings>
                                                </dx:ASPxComboBox>
                                                <dx:ASPxTextBox ID="FAPWF_modal_lbl" runat="server" ClientInstanceName="FAPWF_modal_lbl" HorizontalAlign="Left" ReadOnly="True" Width="170px">
                                                    <BorderLeft BorderStyle="None" />
                                                    <BorderTop BorderStyle="None" />
                                                    <BorderRight BorderStyle="None" />
                                                    <BorderBottom BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:LayoutGroup Caption="FAP Workflow Sequence" ColSpan="1" GroupBoxDecoration="HeadingLine">
                                <Items>
                                    <dx:LayoutItem Caption="" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="FAPWFGrid" runat="server" AutoGenerateColumns="False" Width="350px" ClientInstanceName="FAPWFGrid" OnCustomCallback="FAPWFGrid_CustomCallback" DataSourceID="SqlFAPWF">
                                                    <SettingsEditing Mode="Batch">
                                                    </SettingsEditing>
                                                    <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                                                    <SettingsPopup>
            ...
            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2" GroupBoxDecoration="HeadingLine">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="btnSaveFinal" runat="server" Text="Save" ClientInstanceName="btnSaveFinal" AutoPostBack="False" BackColor="#006DD6">
                                    <ClientSideEvents Click="function(s, e) {
...
SavePopup.Hide();
    ...
    <asp:SqlDataSource ID="SqlRFP" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ACCEDE_T_RFPMain] WHERE ([User_ID] = @User_ID) ORDER BY [ID] DESC">
        <SelectParameters>
