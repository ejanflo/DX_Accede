<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AllAccedeP2PPage.aspx.cs" Inherits="DX_WebTemplate.AllAccedeP2PPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Font-Bold="False" Height="144px" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="ACCEDE P2P Page" ColSpan="1" GroupBoxDecoration="HeadingLine" Width="100%">
                                        ...
                                        <dx:ASPxGridView ID="expenseGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="expenseGrid" Width="100%" DataSourceID="sqlAllApproval" KeyFieldName="WFA_Id" OnCustomCallback="expenseGrid_CustomCallback" OnCustomColumnDisplayText="expenseGrid_CustomColumnDisplayText">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Department" ShowInCustomizationForm="True" VisibleIndex="5">
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataComboBoxColumn Caption="Location" ShowInCustomizationForm="True" VisibleIndex="0" FieldName="Location">
                                                            <PropertiesComboBox DataSourceID="sqlCompanyBranch" TextField="Name" ValueField="ID">
                                                            </PropertiesComboBox>
                                                            <CellStyle HorizontalAlign="Left">
                                                            </CellStyle>
                                                        </dx:GridViewDataComboBoxColumn>
...
ORDER BY DateAssigned">
    ...
    <asp:SqlDataSource ID="sqlCompanyBranch" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ITP_S_CompanyBranch]"></asp:SqlDataSource>
    </asp:Content>
