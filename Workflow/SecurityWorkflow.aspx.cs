...
{
    public partial class SecurityWorkflow : System.Web.UI.Page
    {
        ...
        protected void gridWorkflowDetails_BeforePerformDataSelect(object sender, EventArgs e)
        {
            Session["MasterWorkflowID"] = (sender as ASPxGridView).GetMasterRowKeyValue();
        }

        protected void gridWorkflowDetails_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            e.NewValues["WF_Id"] = (sender as ASPxGridView).GetMasterRowKeyValue();
        }
