<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeP2P_RFPViewPage.aspx.cs" Inherits="DX_WebTemplate.AccedeP2P_RFPViewPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function CheckValidDocNo(SAPDoc, callback) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeP2P_RFPViewPage.aspx/CheckSAPVAlidAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
                    SAPDoc: SAPDoc,
        ...
        function saveFinChanges(stats) {
            ...
            $.ajax({
                type: "POST",
                url: "AccedeP2P_RFPViewPage.aspx/SaveP2PChangesAJAX",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({
                    SAPDoc: SAPDoc,
                ...
                success: function (response) {
                    ...
                    if (funcResult == "success") {
                        ...
                        window.location.href = 'AccedeP2P_RFPViewPage.aspx';
                    }
                },
                error: function (xhr, status, error) {
                    console.log("Error:", error);
	...
	LoadingPanel.Show();
                            ...
                            <dx:LayoutItem Caption="" ColSpan="1" ClientVisible="False" Width="20%" Name="btnCash">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="BtnCashSave" runat="server" AutoPostBack="False" ClientInstanceName="BtnCashSave" Text="Disburse Check" BackColor="#006838">
                                            <ClientSideEvents Click="function(s, e) {
...
CheckValidDocNo(edit_SAPDocNo.GetValue(),1);
                            ...
                            <dx:LayoutItem Caption="" ClientVisible="False" ColSpan="1" Name="BtnSaveDetails">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="BtnSaveDetails" runat="server" BackColor="#006DD6" ClientInstanceName="BtnSaveDetails" Text="Save" AutoPostBack="False">
                                            <ClientSideEvents Click="function(s, e) {
...
if(ASPxClientEdit.ValidateGroup('ViewFormCashier')){
 CheckValidDocNo(edit_SAPDocNo.GetValue(),2);
                            ...
                            <dx:LayoutItem Caption="" ColSpan="1" ClientVisible="False" Name="BtnSaveDetailsUser">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxButton ID="BtnSaveDetailsUser" runat="server" BackColor="#006DD6" ClientInstanceName="BtnSaveDetailsUser" Text="Save" AutoPostBack="False">
                                            <ClientSideEvents Click="function(s, e) {
	saveCreatorChanges();
}" />
                                            <Border BorderColor="#006DD6" />
...
" />
                                    ...
                                    <dx:LayoutItem Caption="" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="DocuGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid" KeyFieldName="ID" OnCustomButtonInitialize="DocuGrid_CustomButtonInitialize" OnCustomCallback="DocuGrid_CustomCallback" OnHtmlDataCellPrepared="DocuGrid_HtmlDataCellPrepared" DataSourceID="SqlRFPDocs">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout2" runat="server" Width="100%">
        <Items>
            ...
            <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Center">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxMemo ID="ASPxFormLayout2_E4" runat="server" Font-Size="Medium" HorizontalAlign="Center" Text="Are you sure to disburse check?" Width="100%">
                            <Border BorderStyle="None" />
                        </dx:ASPxMemo>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
