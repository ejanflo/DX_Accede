                                            ...
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="CAGrid" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlCA" KeyFieldName="ID">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataComboBoxColumn FieldName="Payee" ShowInCustomizationForm="True" VisibleIndex="3">
                            ...
                            <dx:LayoutGroup Caption="Reimbursements" ColSpan="1">
                                <Items>
                                    <dx:LayoutItem Caption="" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="ReimburseGrid0" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlReimDetails" KeyFieldName="ID">
                                                    <ClientSideEvents CustomButtonClick="onCustomButtonClick" />
                                                    <SettingsPopup>
                                                        <FilterControl AutoUpdatePosition="False">
                                                        </FilterControl>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewCommandColumn Caption="Action" ShowInCustomizationForm="True" VisibleIndex="0" Width="120px">
                                                            <CustomButtons>
                                                                ...
                                                                <dx:GridViewCommandColumnCustomButton ID="btnEditReim" Text="Edit" Visibility="Invisible">
                    ...
                    <dx:LayoutGroup Caption="SUPPORTING DOCUMENTS" ColSpan="2" ColumnSpan="2" GroupBoxDecoration="HeadingLine" Width="100%">
                        ...
                        <Items>
                            <dx:LayoutItem Caption="" ColSpan="1">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxGridView ID="DocuGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid" DataSourceID="SqlDocs" KeyFieldName="ID" Width="100%" OnCustomCallback="CADocuGrid_CustomCallback">
