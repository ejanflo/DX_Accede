<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeExpenseReportApprovalReview.aspx.cs" Inherits="DX_WebTemplate.AccedeExpenseReportApprovalReview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	rfpPaymethod.SetValue(e.result);
        ...
        <dx:ASPxCallback ID="rfpCallback" runat="server" ClientInstanceName="rfpCallback" OnCallback="rfpCallback_Callback">
                         ...
                         <dx:ASPxCallback ID="approveCallback" runat="server" ClientInstanceName="approveCallback" OnCallback="approveCallback_Callback">
                         </dx:ASPxCallback>
                         <dx:ASPxCallback ID="retdapprCallback" runat="server" ClientInstanceName="retdapprCallback" OnCallback="retdapprCallback_Callback">
                         </dx:ASPxCallback>
<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Font-Bold="False" Height="144px" Width="100%" style="margin-bottom: 0px" DataSourceID="sqlExpenseMain">
                        ...
                        <dx:LayoutItem Caption="" ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="apprBTN" runat="server" AutoPostBack="False" BackColor="#006838" ClientInstanceName="apprBTN" Font-Bold="True" Font-Size="Small" Text="Approve" ForeColor="White">
	...
	submitPopup.Show();
                        ...
                        <dx:LayoutItem Caption="" ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="retBTN" runat="server" AutoPostBack="False" BackColor="#E67C0E" ClientInstanceName="retBTN" Font-Bold="True" Font-Size="Small" ForeColor="White" Text="Return">
                                        <ClientSideEvents Click="function(s, e) {
	submitPopup0.SetHeaderText(&quot;Return?&quot;);
               subBTN.SetText(&quot;Return&quot;);
                var buttonElement = subBTN.GetMainElement();
                buttonElement.style.backgroundColor = &quot;#E67C0E&quot;;
               submitPopup0.Show();
}" />
                        ...
                        <dx:LayoutItem Caption="" ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="dapprBTN" runat="server" AutoPostBack="False" BackColor="#CC2A17" ClientInstanceName="dapprBTN" Font-Bold="True" Font-Size="Small" ForeColor="White" Text="Disapprove">
                                        <ClientSideEvents Click="function(s, e) {
	submitPopup0.SetHeaderText(&quot;Disapprove?&quot;);
                subBTN.SetText(&quot;Disapprove&quot;);
                var buttonElement = subBTN.GetMainElement();
                buttonElement.style.backgroundColor = &quot;#CC2A17&quot;;
               submitPopup0.Show();
                        ...
                        <dx:LayoutItem Caption="" ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxButton ID="cancelBtn" runat="server" AutoPostBack="False" BackColor="White" ClientInstanceName="cancelBtn" Font-Bold="True" Font-Size="Small" ForeColor="#878787" HorizontalAlign="Right" Text="Cancel" UseSubmitBehavior="False">
                                        <ClientSideEvents Click="function(s, e) {
	window.open(&quot;AccedeExpenseReportView.aspx&quot;, &quot;_self&quot;);
}" />
                                    </dx:ASPxButton>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        ...
                        <dx:LayoutGroup Caption="REPORT DETAILS" ColSpan="1" GroupBoxDecoration="HeadingLine" Width="60%">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Name" ColSpan="1" HorizontalAlign="Left" Width="55%" FieldName="User_ID">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="name" runat="server" ClientInstanceName="name" DataSourceID="sqlName" Font-Bold="True" Font-Size="Small" TextField="FullName" ValueField="EmpCode" Width="100%" ClientEnabled="False">
                                                <DropDownButton Visible="False">
                                                </DropDownButton>
                                ...
                                <dx:LayoutItem Caption="Company" ColSpan="1" HorizontalAlign="Left" Width="55%" FieldName="Company_ID">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="company" runat="server" DataSourceID="sqlCompany" EnableTheming="True" Font-Bold="True" Font-Size="Small" TextField="CompanyDesc" ValueField="WASSId" Width="100%" ClientInstanceName="company" ClientEnabled="False">
	...
	rfpCompany.SetValue(company.GetValue());
                                ...
                                <dx:LayoutItem Caption="Expense Report for" ColSpan="1" Height="20px" HorizontalAlign="Left" VerticalAlign="Bottom" FieldName="ExpenseType_ID">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="expenseType" runat="server" ClientInstanceName="expenseType" DataSourceID="sqlExpenseType" Font-Bold="True" Font-Size="Small" HorizontalAlign="Left" TextField="Description" ValueField="ExpenseType_ID" Width="100%" ClientReadOnly="True" ClientEnabled="False">
                                                <DropDownButton Visible="False">
                                                </DropDownButton>
                                                <ValidationSettings Display="Dynamic" ValidationGroup="submitValid" SetFocusOnError="True">
                                                    <RequiredField ErrorText="*Required" IsRequired="True" />
                                ...
                                <dx:LayoutItem Caption="Purpose" ColSpan="1" HorizontalAlign="Right" FieldName="Purpose">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo ID="purpose" runat="server" ClientInstanceName="purpose" Font-Bold="True" Font-Size="Small" HorizontalAlign="Left" Width="100%" ClientEnabled="False">
                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="submitValid">
                                                    <RequiredField ErrorText="*Required" IsRequired="True" />
                                                </ValidationSettings>
                                                <Border BorderStyle="None" />
                                    ...
                                    <CaptionSettings HorizontalAlign="Left" VerticalAlign="Top" />
                                    <ParentContainerStyle Font-Bold="False" Font-Size="Small">
                                    </ParentContainerStyle>
                                </dx:LayoutItem>
                            </Items>
                        ...
                        <dx:LayoutGroup Caption="CASH ADVANCES" ColSpan="1" Width="50%">
                            ...
                            <Items>
                                <dx:LayoutItem Caption="" ColSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxGridView ID="DocuGrid1" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid" DataSourceID="sqlExpenseCA" Font-Size="Smaller" KeyFieldName="ExpCA_ID" Width="100%" EnableCallBacks="False" OnDataBound="DocuGrid1_DataBound">
                        ...
                        <dx:LayoutGroup Caption="EXPENSES" ColSpan="1" GroupBoxDecoration="Box">
                            ...
                            <Items>
                                <dx:LayoutItem Caption="" ColSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxGridView ID="DocuGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid" DataSourceID="sqlExpenseDetails" Font-Size="Smaller" KeyFieldName="ExpenseReportDetail_ID" EnableCallBacks="False" OnDataBound="DocuGrid_DataBound" Width="100%">
                                                <ClientSideEvents ToolbarItemClick="onToolbarItemClick" />
                                                <SettingsDetail AllowOnlyOneMasterRowExpanded="True" />
                                                <SettingsContextMenu Enabled="True">
                                                </SettingsContextMenu>
                        ...
                        <dx:LayoutGroup Caption="REIMBURSEMENTS" ColSpan="2" ColumnSpan="2" Name="rr" HorizontalAlign="Center" Width="100%">
                            ...
                            <Items>
                                <dx:LayoutItem ColSpan="1" ShowCaption="False">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxGridView ID="DocuGrid0" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid" DataSourceID="sqlRFPMain" Font-Size="Smaller" KeyFieldName="ID" Width="100%" Visible="False">
                                                <ClientSideEvents ToolbarItemClick="onToolbarItemClick" />
                                                <SettingsDetail AllowOnlyOneMasterRowExpanded="True" />
                                                <SettingsContextMenu Enabled="True">
                                                </SettingsContextMenu>
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="TranType" ShowInCustomizationForm="True" Visible="False" VisibleIndex="11">
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataCheckColumn FieldName="isTravel" ShowInCustomizationForm="True" Visible="False" VisibleIndex="12">
                                                    </dx:GridViewDataCheckColumn>
                                                    <dx:GridViewDataTextColumn FieldName="SAPCostCenter" ShowInCustomizationForm="True" VisibleIndex="5">
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn Caption="IO No." FieldName="IO_Num" ShowInCustomizationForm="True" VisibleIndex="6">
                                                    </dx:GridViewDataTextColumn>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="Status" ShowInCustomizationForm="True" Visible="False" VisibleIndex="1">
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn FieldName="RFP_DocNum" ShowInCustomizationForm="True" Visible="False" VisibleIndex="16">
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataDateColumn FieldName="DateCreated" ShowInCustomizationForm="True" VisibleIndex="10">
                                                        <PropertiesDateEdit DisplayFormatString="MMMM dd, yyyy">
                                                        </PropertiesDateEdit>
                                                    </dx:GridViewDataDateColumn>
                                                    ...
                                                    <dx:GridViewDataComboBoxColumn FieldName="PayMethod" ShowInCustomizationForm="True" VisibleIndex="8">
                                                        <PropertiesComboBox DataSourceID="sqlPayMethod" TextField="PMethod_name" ValueField="ID">
                                                        </PropertiesComboBox>
                                                    </dx:GridViewDataComboBoxColumn>
                                                </Columns>
                        ...
                        <dx:LayoutGroup Caption="SUPPORTING DOCUMENTS" ColSpan="1" Width="100%">
                            <Items>
                                <dx:LayoutItem Caption="" ColSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxGridView ID="DocuGrid2" runat="server" AutoGenerateColumns="False" ClientInstanceName="DocuGrid2" DataSourceID="sqlFileAttachment" Font-Size="Small" KeyFieldName="ID" Width="100%">
	...
	window.location = 'FileHandler.ashx?id=' + s.GetRowKey(e.visibleIndex) + '';
                                                ...
                                                <Columns>
                                                    <dx:GridViewCommandColumn Caption="Action" ShowInCustomizationForm="True" VisibleIndex="6">
                                                        <CustomButtons>
                                                    ...
                                                    <dx:GridViewDataDateColumn FieldName="DateUploaded" ShowInCustomizationForm="True" VisibleIndex="5">
                                                        <PropertiesDateEdit DisplayFormatString="MMMM dd, yyyy">
                                                        </PropertiesDateEdit>
                                                    </dx:GridViewDataDateColumn>
                                                    <dx:GridViewDataTextColumn FieldName="FileSize" ShowInCustomizationForm="True" VisibleIndex="4">
                                                    </dx:GridViewDataTextColumn>
                                                </Columns>
                                            </dx:ASPxGridView>
                                        </dx:LayoutItemNestedControlContainer>
        ...
        <asp:SqlDataSource ID="sqlExpenseCA" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ACCEDE_T_RFPMain] WHERE (([Exp_ID] = @Exp_ID) AND ([IsExpenseCA] = @IsExpenseCA))">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="sqlRFPMain" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [ACCEDE_T_RFPMain] WHERE (([Exp_ID] = @Exp_ID) AND ([IsExpenseReim] = @IsExpenseReim))">
            <SelectParameters>
                <asp:SessionParameter Name="Exp_ID" SessionField="cID" />
            ...
            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2" HorizontalAlign="Right" GroupBoxDecoration="None">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1" Width="1px">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="popupSubmitBtn" runat="server" Text="Add" BackColor="#006838" ClientInstanceName="popupSubmitBtn" Font-Size="Small" ForeColor="White" Font-Bold="True" ValidationGroup="PopupSubmit" UseSubmitBehavior="False">
                                    <ClientSideEvents Click="function(s, e) {
...
<dx:PopupControlContentControl runat="server">
	...
	if(rfpTravel.GetChecked()){
                    ...
                    <dx:LayoutItem Caption="Last Day of Transaction" ColSpan="1" Name="lastday" ClientVisible="False">
                        <LayoutItemNestedControlCollection>
<dx:LayoutItemNestedControlContainer runat="server">
    <dx:ASPxDateEdit ID="rfpLastday" runat="server" ClientInstanceName="rfpLastday" Font-Bold="True" Font-Size="Small" Width="100%" DisplayFormatString="MMMM dd, yyyy">
        <ValidationSettings Display="Dynamic" ValidationGroup="rfpValid">
            <RequiredField ErrorText="*Required" IsRequired="True" />
        </ValidationSettings>
    </dx:ASPxDateEdit>
            ...
            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2" HorizontalAlign="Right" GroupBoxDecoration="None">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1" Width="1px">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="rfppopupSubmitBtn" runat="server" Text="Add" BackColor="#006838" ClientInstanceName="rfppopupSubmitBtn" Font-Size="Small" ForeColor="White" Font-Bold="True" ValidationGroup="rfpValid" UseSubmitBehavior="False">
                                    <ClientSideEvents Click="function(s, e) {
	if(ASPxClientEdit.ValidateGroup('rfpValid')){
                      rfpCallback.PerformCallback();
                      loadPanel.Show();
               }
}" />
                                </dx:ASPxButton>
...
<dx:PopupControlContentControl runat="server">
            ...
            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="2" ColumnSpan="2">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="capopGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="capopGrid" DataSourceID="sqlRFPMainCA" Font-Size="Smaller" KeyFieldName="ID" Width="100%">
                                    <ClientSideEvents ToolbarItemClick="onToolbarItemClick" />
                                    <SettingsAdaptivity AdaptivityMode="HideDataCells">
                                        <AdaptiveDetailLayoutProperties>
                                            <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit">
            ...
            <dx:LayoutGroup Caption="" ColCount="2" ColSpan="1" ColumnCount="2" HorizontalAlign="Right" GroupBoxDecoration="None">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1" Width="1px">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="popupSubmitBtn0" runat="server" Text="Add" BackColor="#006838" ClientInstanceName="popupSubmitBtn" Font-Size="Small" ForeColor="White" Font-Bold="True" ValidationGroup="PopupSubmit" UseSubmitBehavior="False">
                                    <ClientSideEvents Click="function(s, e) {
	if(capopGrid.GetSelectedRowCount() &gt; 0){
        ...
        <dx:ASPxPopupControl ID="submitPopup" runat="server" ClientInstanceName="submitPopup" HeaderText="Approve?" Height="182px" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="383px">
            <ContentCollection>
<dx:PopupControlContentControl runat="server">
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="ASPxButton1" runat="server" BackColor="#006838" Font-Bold="True" Font-Size="Small" Text="Yes">
                                    <ClientSideEvents Click="function(s, e) {
	approveCallback.PerformCallback();
               submitPopup.Hide();
               loadPanel.Show();
}" />
                                </dx:ASPxButton>
	...
	submitPopup.Hide();
        ...
        <dx:ASPxPopupControl ID="submitPopup0" runat="server" ClientInstanceName="submitPopup0" HeaderText="Approve?" Height="182px" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="383px">
            <ContentCollection>
<dx:PopupControlContentControl runat="server">
            ...
            <dx:LayoutGroup ColSpan="1" GroupBoxDecoration="None">
                <Items>
                    <dx:LayoutItem Caption="" ColSpan="1">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxLabel ID="ASPxFormLayout7_E2" runat="server" Text="Remarks:">
                                </dx:ASPxLabel>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    <dx:LayoutItem Caption="" ColSpan="1">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxMemo ID="remarks" runat="server" ClientInstanceName="remarks" Height="71px" Width="100%">
                                    <ClientSideEvents UserInput="function(s, e) {
	if(remarks.GetText() != ''){
		 ...
		 subBTN.SetVisible(false);
                    ...
                    <dx:LayoutItem Caption="" ColSpan="1" HorizontalAlign="Right">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="subBTN" runat="server" BackColor="#006838" Font-Bold="True" Font-Size="Small" Text="Yes" ClientInstanceName="subBTN" ClientVisible="False">
                                    <ClientSideEvents Click="function(s, e) {
	if(subBTN.GetText() == &quot;Return&quot;){
	          retdapprCallback.PerformCallback('Return');
               }else if(subBTN.GetText() == &quot;Disapprove&quot;){
                          retdapprCallback.PerformCallback('Disapprove');
               }
               submitPopup.Hide();
               loadPanel.Show();
}" />
                                </dx:ASPxButton>
                                <dx:ASPxButton ID="ASPxButton8" runat="server" AutoPostBack="False" BackColor="White" Font-Bold="True" Font-Size="Small" ForeColor="#878787" Text="Cancel">
                                    <ClientSideEvents Click="function(s, e) {
               remarks.SetText(&quot;&quot;);
               subBTN.SetVisible(false);
	submitPopup0.Hide();
