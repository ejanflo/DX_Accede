<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TravelExpenseP2P.aspx.cs" Inherits="DX_WebTemplate.TravelExpenseP2P" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Font-Bold="False" Height="144px" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Travel Expense P2P Page" ColSpan="1" GroupBoxDecoration="HeadingLine" Width="100%">
