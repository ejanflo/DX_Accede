...
{
    public partial class AccedeExpenseReportPrinting : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                AccedeExpenseReportForm report = new AccedeExpenseReportForm();
                ...
                try
                {
                    ...
                    //Forward Approval
                    var forAppr1 = "Ni Wang Kho";
                    var forAppr1Pos = "";
                    var forAppr1Date = DateTime.Now;

                    var forAppr2 = "Tiburcio Z. Policarpio";
                    var forAppr2Pos = "";
                    ...
                    var desig = context.ITP_S_UserMasters
                        ...
                        .Select(x => x.DesDesc)
                        .FirstOrDefault();
                    var stat_id = context.ITP_S_Status.Where(x => x.STS_Name == "Payment Released").Select(x => x.STS_Id).FirstOrDefault();
                    var cashadvance = context.ACCEDE_T_RFPMains.Where(x=>x.IsExpenseCA == true && x.Exp_ID == em.ID).Sum(x => x.Amount);
