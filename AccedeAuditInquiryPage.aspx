<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AccedeAuditInquiryPage.aspx.cs" Inherits="DX_WebTemplate.AccedeAuditInquiryPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function OnCustomButtonClick(s, e) {
            ...
            if (e.buttonID == 'btnViewAppHistory') {

                //displayRFPDetails(s.GetRowKey(e.visibleIndex));
                gridMainApproved.PerformCallback(s.GetRowKey(e.visibleIndex) + "|" + e.buttonID);
                LoadingPanel.Show();
...
<div class="centerPane conta" id="form1">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="90%" Theme="iOS">
        <Items>
            <dx:LayoutGroup Caption="Audit Inquiry Page" ColSpan="1" GroupBoxDecoration="HeadingLine">
                <GroupBoxStyle>
                ...
                <Items>
                    ...
                    <dx:TabbedLayoutGroup ActiveTabIndex="1" ColSpan="1">
                        <Items>
                                    ...
                                    <dx:LayoutItem Caption="" ColSpan="1" Width="100%">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gridMain" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMain" DataSourceID="SqlExpReport" EnableTheming="True" KeyFieldName="ID" OnCustomButtonInitialize="gridMain_CustomButtonInitialize" OnCustomCallback="gridMain_CustomCallback" OnHtmlDataCellPrepared="gridMain_HtmlDataCellPrepared" Theme="iOS" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn AdaptivePriority="2" Caption="Transaction Type" FieldName="ExpTypeName" ShowInCustomizationForm="True" VisibleIndex="6">
                                                        </dx:GridViewDataTextColumn>
                            ...
                            <dx:LayoutGroup Caption="Approval History" ColSpan="1">
                                <Items>
                                    <dx:LayoutItem Caption="" ColSpan="1">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxGridView ID="gridMainApproved" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMainApproved" DataSourceID="SqlApprovalHistory" EnableTheming="True" KeyFieldName="ID" OnCustomButtonInitialize="gridMainApproved_CustomButtonInitialize" OnCustomCallback="gridMainApproved_CustomCallback" OnHtmlDataCellPrepared="gridMainApproved_HtmlDataCellPrepared" Theme="iOS" Width="100%">
                                                    <ClientSideEvents CustomButtonClick="OnCustomButtonClick" ToolbarItemClick="OnToolbarItemClick" />
                                                    <SettingsDetail AllowOnlyOneMasterRowExpanded="True" />
                                                    <SettingsContextMenu Enabled="True">
                                                    </SettingsContextMenu>
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewCommandColumn Caption="Action" ShowInCustomizationForm="True" VisibleIndex="0">
                                                            <CustomButtons>
                                                                <dx:GridViewCommandColumnCustomButton ID="btnViewAppHistory" Text="Open">
                                                                    <Image IconID="actions_open_svg_white_16x16" ToolTip="Open Document">
                                                                    </Image>
                                                                    <Styles>
                                                                        <Style BackColor="#0D6943" Font-Bold="True" Font-Size="Smaller" ForeColor="White">
    ...
    <asp:SqlDataSource ID="SqlApprovalHistory" runat="server" ConnectionString="<%$ ConnectionStrings:ITPORTALConnectionString %>" SelectCommand="SELECT * FROM [vw_ACCEDE_I_ApprovalHistory] WHERE (([ActedBy_User_Id] = @ActedBy_User_Id) AND ([STS_Name] = @STS_Name) AND ([WF_Name] = @WF_Name))">
        <SelectParameters>
            <asp:Parameter Name="ActedBy_User_Id" Type="String" />
            <asp:Parameter DefaultValue="Approve" Name="STS_Name" Type="String" />
            <asp:Parameter DefaultValue="ACDE AUDIT" Name="WF_Name" Type="String" />
        </SelectParameters>
     </asp:SqlDataSource>
</asp:Content>
